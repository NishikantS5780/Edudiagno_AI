  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, we offer a 14-day free trial on our Starter and Professional plans. No credit card required until you decide to continue.",
    },
    {
      question: "Can I upgrade or downgrade my plan later?",
      answer:
        "Absolutely! You can upgrade your plan at any time, and the new features will be immediately available. Downgrades will take effect at the start of your next billing cycle.",
    },
    {
      question: "How are AI interviews counted?",
      answer:
        "Each completed AI interview with a candidate counts as one interview. Incomplete interviews or those abandoned by candidates don't count against your quota.",
    },
    {
      question: "Do unused interviews roll over to the next month?",
      answer:
        "No, interview quotas reset at the beginning of each billing cycle. However, Enterprise customers can discuss custom rollover arrangements with their account manager.",
    },
    {
      question: "What payment methods do you accept?",
      answer:
        "We accept all major credit cards, PayPal, and direct bank transfers for Enterprise customers. All payments are processed securely through our payment providers.",
    },
    {
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              Choose the plan that's right for your business, and start hiring
              smarter with AI
            </p>
                ...
                return (
                  <Card
                    ...
                    className={`h-full flex flex-col ${
                      plan.highlight ? "shadow-lg border-brand/50 relative" : ""
                    }`}
                  >
                    ...
                    <CardFooter>
                      ...
                      >
                        <Button
                          className={`w-full ${
                            plan.highlight ? "bg-brand hover:bg-brand/90" : ""
                          }`}
                        >
                          {plan.cta}
            ...
            <div className="min-w-[800px] max-w-6xl mx-auto">
              <Tabs defaultValue="hiring-features" className="w-full">
                <TabsList className="grid w-full grid-cols-3 mb-8">
                  <TabsTrigger value="hiring-features">
                    Hiring Features
                  </TabsTrigger>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p className="max-w-xs text-sm">
                              Number of job listings you can have active
                              simultaneously
                            </p>
                          </TooltipContent>
                        </Tooltip>
                ...
                <TabsContent value="analytics">
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="col-span-1 text-center">PDF, CSV</div>
                    <div className="col-span-1 text-center">PDF, CSV, API</div>
                    ...
                    <div className="col-span-1 text-center">3 months</div>
                    <div className="col-span-1 text-center">12 months</div>
                    <div className="col-span-1 text-center">Unlimited</div>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="team-support">
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="col-span-1 text-center">Priority email</div>
                    <div className="col-span-1 text-center">
                      Dedicated manager
                    </div>
                    ...
                    <div className="col-span-1 text-center">48 hours</div>
                    <div className="col-span-1 text-center">24 hours</div>
                    <div className="col-span-1 text-center">4 hours</div>
                    ...
                    <div className="col-span-1 text-center">Self-serve</div>
                    <div className="col-span-1 text-center">Group session</div>
                    <div className="col-span-1 text-center">
                      Dedicated setup
                    </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-16">
            <p className="mb-4 text-muted-foreground">Need more information?</p>
            <Link to="/contact">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
              No credit card required. Experience the full power of our AI
              hiring platform risk-free.
            </p>
