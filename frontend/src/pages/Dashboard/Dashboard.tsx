...
const Dashboard = () => {
  ...
  //   {
  //     name: "Screened",
  //     value: interviews.filter((i) => i.resumeMatchScore !== null).length || 0,
  //   },
  //   {
  //     name: "Interviewed",
  ...
  //     name: "Shortlisted",
  //     value:
  //       interviews.filter((i) => i.overallScore && i.overallScore >= 80)
  //         .length || 0,
  //   },
  //   {
  //     name: "Hired",
  //     value: interviews.filter((i) => i.status === "hired").length || 0,
  //   },
  // ];
  ...
  //         screened: interviews.filter((i) => i.resumeMatchScore !== null)
  //           .length,
  //         interviewed: interviews.filter((i) => i.status === "completed")
  //           .length,
  //         shortlisted: interviews.filter(
  //           (i) => i.overallScore && i.overallScore >= 80
  //         ).length,
  //         hired: interviews.filter((i) => i.status === "hired").length,
  //       },
  //     };
  ...
  //     link.setAttribute(
  //       "download",
  //       `dashboard_report_${format(new Date(), "yyyy-MM-dd")}.csv`
  //     );
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
                        ...
                        // const total = pipelineData.reduce(
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Performance metrics by job position
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      >
                        ...
                        <div className="col-span-3 text-center">
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <Badge
                              variant={
                                job.avgScore >= 80 ? "success" : "warning"
                              }
                            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Distribution of candidate applications by source
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-80">
