...
const CaseStudies = () => {
  const caseStudies = [
    ...
    },
    {
      ...
      industry: "Healthcare",
      challenge:
        "Specialized roles requiring technical and soft skills assessment",
      solution: "Customized AI interviews with role-specific questions",
      results:
        "Increased qualified candidate pool by 35%, reduced turnover by 28%",
    ...
    },
    {
      ...
      results:
        "Processed 10,000+ applications in 2 weeks with 5-person HR team",
    ...
    },
    {
      ...
      results:
        "100% compliance adherence, 45% faster hiring for regulated positions",
    ...
    },
    {
      ...
      industry: "Education",
      challenge:
        "Distributed hiring across multiple campuses with inconsistent standards",
      solution:
        "Centralized AI interview platform with standardized assessment",
      results:
        "Standardized hiring quality across 15 locations, 52% cost reduction",
    ...
    },
    {
      ...
      challenge:
        "High-volume driver recruitment with safety critical assessment",
      ...
      <div className="container py-12 md:py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            See how leading companies revolutionized their hiring process with
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join these successful companies and experience the benefits of
            AI-powered hiring
          </p>
          <Link to="/signup">
