...
const initialConversation = [
  {
    sender: "ai",
    message:
      "Hello! Welcome to your AI interview. I'm your AI interviewer today. Are you ready to begin?",
...
const CandidateInterview = () => {
      ...
      timer = setInterval(() => {
        setTimeRemaining((prev) => {
          ...
          setCurrentProgress(
            100 -
              (newTime /
                interview.questions[currentQuestionIndex].time_allocation) *
                100
          );
          return newTime;
        });
  ...
  const handleResponseRecorded = async () => {
    ...
    try {
      const { score, feedback } = await processResponse(
        interview.questions[currentQuestionIndex].id.toString(),
        simulatedResponse
      );
  ...
  const handleNextQuestion = () => {
    ...
    if (currentQuestionIndex < interview.questions.length - 1) {
      ...
      setTimeRemaining(
        interview.questions[currentQuestionIndex + 1].time_allocation
      );
      ...
      setTimeout(() => {
        ...
        addMessage(
          "ai",
          interview.questions[currentQuestionIndex + 1].question
        );
        setTimeout(() => setIsAiSpeaking(false), 3000);
      }, 1000);
    }
  ...
  const simulateResponse = (questionIndex: number) => {
    ...
    return (
      ...
      "I believe my experience and skills align well with what you're looking for. I'm passionate about delivering high-quality solutions and continuously learning new technologies."
    );
  };
  ...
  const handleDownloadTranscript = () => {
    const transcriptText = conversation
      .map(
        (msg) =>
          `${msg.sender === "ai" ? "AI Interviewer" : "You"}: ${msg.message}`
      )
      .join("\n\n");
        ...
        <Card className="max-w-2xl w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              ...
              {interview.job.company.company_name}
            </CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  {isInterviewActive ? (
                    <>
                      ...
                      <div className="absolute bottom-8 left-8 flex flex-col items-center">
                        <AIAvatar isSpeaking={isAiSpeaking} size="md" />
                    ...
                    <div className="text-center p-10">
                      ...
                      <p className="text-muted-foreground mb-4 max-w-md mx-auto">
                        When you're ready to begin, click the button below to
                        start your AI interview experience
                      </p>
                  ...
                  {isPreparing && (
                    <div className="absolute inset-0 bg-background/90 backdrop-blur-sm flex flex-col items-center justify-center">
                      ...
                      <p className="text-sm max-w-md text-center text-muted-foreground">
                        Take a moment to gather your thoughts. The interview
                        will start automatically when the timer ends.
                      </p>
                      <Button
                        className="mt-8"
                        onClick={() => {
            ...
            <div className="col-span-1 lg:col-span-2 border-l border-t lg:border-t-0 bg-background/95 backdrop-blur-sm flex flex-col h-full overflow-hidden">
              <div className="p-4 border-b">
                <Tabs defaultValue="transcript" className="w-full">
                  ...
                  <TabsContent
                    value="transcript"
                    className="mt-4 space-y-4 h-[150px] overflow-y-auto"
                  >
          ...
          >
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Your response has been recorded. When you're ready, we'll
          ...
          >
            <AlertDialogContent className="max-w-2xl">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Review the following information before starting your
                  interview
                </AlertDialogDescription>
              </AlertDialogHeader>
              ...
              <div className="py-4 space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <img
                        src={interview.job.company.company_logo}
                        alt={interview.job.company.company_name}
                        className="h-6 w-6 rounded-md"
                      />
                      <span>{interview.job.company.company_name}</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-3">
                      ...
                      <p>
                        You'll have 30 seconds to prepare before answering each
                        question
                      </p>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <p>
                        Respond naturally to each question - this is a
                        conversation
                      </p>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <p>
                        After the interview, your responses will be analyzed by
                        AI and reviewed by the hiring team
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li>
                      ✓ Take a moment to think about your answers if needed
                    </li>
                    <li>
                      ✓ Be authentic and showcase your real skills and
                      experience
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-muted p-4 rounded-md">
                  <p className="text-sm">
                    ...
                    recorded for evaluation purposes. This interview will be
                    analyzed by AI and reviewed by the hiring team at{" "}
                    {interview.job.company.company_name}.
                  </p>
                </div>
              </div>
          ...
          >
            <AlertDialogContent className="max-w-2xl">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Make sure your devices are working properly before starting
                  the interview
                </AlertDialogDescription>
              </AlertDialogHeader>
              ...
              <div className="py-4 space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-3 h-3 rounded-full ${
                          cameraWorking ? "bg-success" : "bg-destructive"
                        }`}
                      ></div>
                      <span>Camera</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-3 h-3 rounded-full ${
                          micWorking ? "bg-success" : "bg-destructive"
                        }`}
                      ></div>
                ...
                <div className="bg-muted p-4 rounded-md">
                  <p className="text-sm">If your devices aren't working:</p>
                  <ul className="text-sm mt-2 space-y-1">
                    <li>
                      • Make sure you've granted browser permissions for camera
                      and microphone
                    </li>
              ...
              <AlertDialogFooter className="flex-col sm:flex-row gap-2">
                <AlertDialogCancel onClick={stopDeviceTest}>
                  Cancel
                </AlertDialogCancel>
                <Button
                  ...
                  onClick={() => {
                    if (
                      ...
                      !testVideoRef.current.srcObject
                    ) {
                      startDeviceTest();
                    } else {
                      stopDeviceTest();
          ...
          <AlertDialog>
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Your response has been recorded. You can only record one
                  response per question. Would you like to proceed to the next
                  question?
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
